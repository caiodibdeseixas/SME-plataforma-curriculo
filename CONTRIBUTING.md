...
[issues do GitHub](https://github.com/prefeiturasp/SME-plataforma-curriculo/issues). Porém antes
...
Para criar seu pedido de recurso basta
[criar uma nova issue](https://github.com/prefeiturasp/SME-plataforma-curriculo/issues/new) usando
o label **recurso**.
/new) usando
o label **recurso**.
